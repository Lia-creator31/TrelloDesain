            ...
            {popupOpen && (
                <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-5 rounded-md w-96">
                        ...
                        <div className="mt-2">
                            <button className="bg-blue-500 text-white px-3 py-1 rounded mr-2" onClick={handleAddLink}>Add Link</button>
                            <input type="file" multiple className="hidden" id="fileUpload" onChange={handleFileUpload} />
                            <label htmlFor="fileUpload" className="bg-green-500 text-white px-3 py-1 rounded cursor-pointer">Upload File</label>
                        </div>
                        ...
                        <button className="bg-blue-500 text-white px-3 py-1 rounded mt-2" onClick={handleSave}>Save</button>
                        <button className="bg-green-500 text-white px-3 py-1 rounded mt-2 ml-2" onClick={closePopup}>Close</button>
                        <button className="bg-red-500 text-white px-3 py-1 rounded mt-2 ml-2" onClick={handleDeleteItemInPopup}>Delete</button>
